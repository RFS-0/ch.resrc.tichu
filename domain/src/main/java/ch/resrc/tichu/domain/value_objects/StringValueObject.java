 ...
 * need to map objects of this type to {@code String}s. They can use a generic sub-mapper that maps
 * {@code StringValueObject} by using the {@code toString} method.</p>
 */
