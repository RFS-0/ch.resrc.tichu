...
public class ValidationErrorModifier {
  ...
  /**
   * Returns an operator that prepends the given text to the error details of a validation error. The text serves as
   * context for the
  ...
  /**
   * Returns an operator that prepends the name of the given class to the error details of a validation error. The class
   * name serves as
   * context for the remaining error details. The class name is converted to lower case with camel case replaced by
   * spaces.
   * <p>
   * Normally, this operator is used for domain classes whose names have direct meaning to clients. Don't use this
   * operators for
  ...
  /**
   * Returns an operator that replaced the error details with the text 'must be specified'. This is a recurring error
   * message
  ...
  /**
   * Returns an operator that replaced the error details with the text 'cannot be undefined'. This is a recurring error
   * message
   * stereotype. It serves to ensure consistent use of this error message.
   *
   * @return the operator, as explained.
  ...
  /**
   * Returns an operator that prepends the specified index to the error details if the error type is {@link
