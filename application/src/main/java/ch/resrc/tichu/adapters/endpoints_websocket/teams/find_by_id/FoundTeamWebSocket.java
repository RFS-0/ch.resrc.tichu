...
@ServerEndpoint(Teams.FOUND_BY_ID)
public class FoundTeamWebSocket {

  private static final Logger LOG = LoggerFactory.getLogger(FoundTeamWebSocket.class);
  private static final Map<Id, Set<Session>> SESSIONS = new ConcurrentHashMap<>();

  public FoundTeamWebSocket() {
  }
