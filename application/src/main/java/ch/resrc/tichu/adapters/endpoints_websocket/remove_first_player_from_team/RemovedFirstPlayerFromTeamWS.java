...
@ServerEndpoint(WebSocketAddresses.UseCases.Output.REMOVE_FIRST_PLAYER_FROM_TEAM)
public class RemovedFirstPlayerFromTeamWS {
  ...
  public String send(RemoveFirstPlayerFromTeamWebSocketOutput output) {
