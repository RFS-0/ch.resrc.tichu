...
@ServerEndpoint(WebSocketAddresses.UseCases.Output.UPDATE_CARD_POINTS_OF_ROUND)
public class UpdatedCardPointsOfRoundWS {
  ...
  public String send(UpdateCardPointsOfRoundWebSocketOutput output) {
