package ch.resrc.tichu.adapters.endpoints_websocket.finish_game.output;
...
public class FinishGameWebSocketOutput {

  private final Json json;
  private final Id receiver;
  private final GameDto gameDto;

  public FinishGameWebSocketOutput(Json json, FinishGameOutput.Response response) {
    this.json = json;
