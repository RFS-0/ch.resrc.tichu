package ch.resrc.tichu.adapters.endpoints_websocket.remove_first_player_from_team.output;
...
public class RemoveFirstPlayerFromTeamWebSocketOutput {

  private final Json json;
  private final Id receiver;
  private final GameDto gameDto;

  public RemoveFirstPlayerFromTeamWebSocketOutput(Json json, RemoveFirstPlayerFromTeamOutput.Response response) {
    this.json = json;
