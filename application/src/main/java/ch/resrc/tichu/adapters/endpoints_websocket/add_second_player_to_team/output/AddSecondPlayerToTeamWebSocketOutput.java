package ch.resrc.tichu.adapters.endpoints_websocket.add_second_player_to_team.output;
...
public class AddSecondPlayerToTeamWebSocketOutput {

  private final Json json;
  private final Id receiver;
  private final GameDto gameDto;

  public AddSecondPlayerToTeamWebSocketOutput(Json json, AddSecondPlayerToTeamOutput.Response response) {
    this.json = json;
