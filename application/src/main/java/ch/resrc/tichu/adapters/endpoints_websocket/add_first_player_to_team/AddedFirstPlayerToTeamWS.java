...
@ServerEndpoint(WebSocketAddresses.UseCases.Output.ADD_FIRST_PLAYER_TO_TEAM)
public class AddedFirstPlayerToTeamWS {
  ...
  public String send(AddFirstPlayerToTeamWebSocketOutput output) {
