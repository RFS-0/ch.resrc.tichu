package ch.resrc.tichu.usecases;
 ...
 * implementation of the {@link #invoke()} operation. When {@link #invoke()} gets called, the use case gets enacted.
 *
 ...
 * #invoke()} method normally sets of the use case execution by just calling one of the role objects.
 * </p>
 *
