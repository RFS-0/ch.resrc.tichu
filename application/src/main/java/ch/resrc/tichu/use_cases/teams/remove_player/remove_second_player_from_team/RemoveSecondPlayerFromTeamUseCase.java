package ch.resrc.tichu.use_cases.teams.remove_player.remove_second_player_from_team;
...
public class RemoveSecondPlayerFromTeamUseCase implements RemoveSecondPlayerFromTeam {

  private static final Logger LOG = LoggerFactory.getLogger(RemoveSecondPlayerFromTeamUseCase.class);

  private final OutboundPorts ports;

  private RemoveSecondPlayerFromTeamUseCase(OutboundPorts ports) {
    this.ports = ports;
  }
  ...
  static class TeamsSource extends Eventful implements EventForwarding {
    ...
    public Object on(Object anEvent) {
      Match(anEvent).of(
        ...
        Case($(instanceOf(TeamFound.class)), found -> publish(removeSecondPlayer(found.team()))),
        DefaultIgnore()
      );
      return anEvent;
    }
    ...
    Event removeSecondPlayer(Team team) {
      return null;
    }
  }
  ...
  public static RemoveSecondPlayerFromTeamUseCase create(OutboundPorts ports) {
    return new RemoveSecondPlayerFromTeamUseCase(ports);
  }
