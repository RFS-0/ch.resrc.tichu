...
public class AddSecondPlayerToTeamUseCase implements AddSecondPlayerToTeamInput {
  ...
  public AddSecondPlayerToTeamUseCase(GetAllGames getAllGames,
  ...
  public AddFirstPlayerToTeamOutput.Response apply(Request requested) {
    ...
    Team updatedTeam = teamToAddPlayerTo.butSecondPlayer(playerToAdd);
