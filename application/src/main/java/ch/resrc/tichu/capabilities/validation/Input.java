...
/**
 * Represents an input value. Associates origin information to the input value. The origin information is used in error messages if the
...
public abstract class Input<T> {
  ...
  /**
   * Creates a new instance for a value of unknown origin. The origin information on the input object signals that the origin is
   * unknown.
   *
  ...
  /**
   * Turns an array of raw input into a list of {@code Input} objects using the supplied mapping function. If the array is null, an
   ...
   * <p>
   * Returns a success whose value is an input of the parsed value if the value parses successfully. The returned input has the same
  ...
  /**
   * Maps the input value to another value. The result is a new {@code Input} with the same origin as this {@code Input} but with the
  ...
  /**
   * Maps the input value to another {@code Input}. The origin of the result is a concatenation of the origin of this input with the
  ...
  /**
   * Creates a failed {@code Try} with an {@link InvalidInputDetected} exception if the input is absent. Returns this input wrapped in
