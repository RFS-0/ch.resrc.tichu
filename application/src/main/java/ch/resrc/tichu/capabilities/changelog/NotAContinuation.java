...
/**
 * Signals that the {@link ChangeLog} that throws this exception is not the continuation of another {@code ChangeLog} but is required
 * to be a continuation in the context of the throwing operation.
 *
