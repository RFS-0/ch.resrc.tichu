...
public abstract class Try<V> {
  ...
  /**
   * Creates a success result that contains the specified non-null value. Intended to be used by operations as a return value to signal
  ...
  /**
   * Creates a success result for a void operation. Intended to be used by void operations as a return value to signal successful
   * completion.
   *
  ...
  /**
   * Creates a failure result that contains the specified exception. Intended to be used by operations as a return value to signal
   * failure.
   *
  ...
  /**
   * Creates an empty result that contains no value. Use this as the result of an operation if the operation is not a void operation
  ...
  /**
   * Shortcut for {@code Result.of(() -> value)}. Use this if the return value of an operation is already known and you want to process
   * it with the fluent interface of {@code Try}. The processing may turn the {@code Try} into a failure if one of the processing steps
   * throws an exception.
   *
   ...
   * @return a success {@code Result<Void>} if the operation completes successfully. A failure {@code Try} if the operation throws an
   ...
   * @return the {@code Try} returned by the operation or a failure {@code Try} if the operation throws an exception. The failure
   ...
   * @return a successful {@code Try} with the {@code Optional}'s value if the {@code Optional} is non-empty. An empty {@code Try} if
   * the {@code Optional} is empty. A failure {@code Try} if the operation throws an exception. The failure {@code Try} contains that
   * exception.
   */
  ...
  /**
   * Shortcut for {@code Result.of(() -> optional)}. Use this if the {@code Optional} outcome of an operation is already known and you
   ...
   * @return a success {@code Try} with the {@code Optional}'s value if the {@code Optional} is non-empty. An empty {@code Try} if the
   ...
   * @return a new success {@code Try} with the mapped value if this {@code Try} is a success. This {@code Try} if it is not a success.
  ...
  /**
   * Turns a success {@code Try} into a new {@code Try} that represents the outcome of the specified operation. Does nothing if this
   * {@code Try} is not a success.
   *
   * @param operation the operation to invoke
   * @param <U>       the type of value produced by the operation
   * @return a success {@code Try} with the outcome of the operation. A failure {@code Try} if the operation throws an exception. The
  ...
  /**
   * Applies the given function to the result value if this object is a success. Returns the {@code Try} produced by the mapping.
   *
   * @param mapping maps the value of this {@code Try} to another {@code Try}
   * @param <U>     the value type of the mapped {@code Try}
   * @return the {@code Try} produced by the mapping or a failure {@code Try} if the mapping throws an exception. The failure {@code
  ...
  /**
   * Applies the specified side effect if this {@code Try} is a success and checks it for exceptions. Does nothing if this result is
   * not a success.
   *
   ...
   * @return this {@code Try} if the effect completes normally. A failure {@code Try} if the effect throws an exception. The failure
   * {@code Try} contains that exception.
   */
   ...
   * @return a failure {@code Try} with the mapped exception if this {@code Try} is a failure. This {@code Try} if it is not a failure.
  ...
  /**
   * Maps an empty {@code Try} to a failure {@code Try}. Use this if  an empty {@code Try} means a failure in your context.
   *
   * @param failureSignal supplies the exception that represents the failure
   * @return a failure {@code Try} with the specified exception if this {@code Try} is empty. This {@code Try} if it is non-empty. A
   ...
   * @return the success value if this {@code Try} is a success. The specified default value if this {@code Try} is empty or a failure
  ...
  /**
   * @return the success value, if present. Null if the result is empty or a void success result. Throws the exception if the result is
   * a failure.
   * @throws RuntimeException if this {@code Try} is a failure. Throws the exception contained in the failure.
   */
  ...
  /**
   * Throws an exception if this {@code Try} is a failure. Throws the exception contained in the failure {@code Try}. Does nothing if
   ...
   * @return a success {@code Try} if this result is a failure. Empty if this result is empty. A failure {@code Try} if the mapping
   * throws an exception. The failure {@code Try} contains that exception. This {@code Try} if it is already a success.
   */
  ...
  /**
   * Invokes the given consumer on the success value if this {@code Try} is a success and checks the consumption for exceptions. Does
   ...
   * @return this {@code Try} if it is a success and the effect completes normally. A failure {@code Try} if the effect throws an
   * exception.
   */
  ...
  /**
   * Maps a failure to another failure if the failure's exception is of the specified type. Identity if the result is not a failure or
  ...
  /**
   * Applies the given effect to the exception if this {@code Try} is a failure. Does nothing if this {@code Try} is either a success
   * or empty.
   *
   * @param failureEffect the effect to apply to the failure exception
   * @return this {@code Try} if the effect completes normally. A new failure {@code Try} if the effect throws an exception. The new
  ...
  /**
   * Checks whether the success value of this {@code Try} satisfies the specified condition. Does nothing if this {@code Try} is not a
   * success.
   *
   * @param condition the condition to check on the success value
   * @return this {@code Try} if the condition matches or if this {@code Try} is not a success. An empty {@code Try} if this {@code
